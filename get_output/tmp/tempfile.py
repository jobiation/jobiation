...
import shutil
import os
hostsfile = open('jobs/20221221_2031/hosts', 'a+');
inventoryfile = open('../inventory.csv', 'r');
playbookfile = open('jobs/20221221_2031/jobiation_task.yaml', 'w');
playbookfile.write('---\n');
...
playbookfile.write('     copy: content="{{ jobiation_facts }}" dest="jobs/20221221_2031/facts/{{ inventory_hostname }}_facts.txt"\n');
...
playbookfile.write('   - name: copy_output_to_file\n');
playbookfile.write('     copy: content="{{ showrun.stdout[0] }}" dest="jobs/20221221_2031/showrun/{{ inventory_hostname }}_showrun.txt"\n');
playbookfile.write('   - name: showver\n');
playbookfile.write('     cisco.ios.ios_command:\n');
playbookfile.write('       commands: show version\n');
playbookfile.write('     register: showver\n');
playbookfile.write('   - name: copy_output_to_file\n');
playbookfile.write('     copy: content="{{ showver.stdout[0] }}" dest="jobs/20221221_2031/showver/{{ inventory_hostname }}_showver.txt"\n');
